              ...
              <div className="py-8 text-base leading-6 space-y-4 text-gray-700 sm:text-lg sm:leading-7">
                ...
                <form onSubmit={handleSubmit} className="space-y-6">
                  <div>
                    ...
                    <input
                      ...
                      name="duration"
                      id="duration"
                      placeholder="e.g., about 30 minutes, a quick 15-minute session"
                  ...
                  <div>
                    <label htmlFor="targetArea" className="block text-sm font-medium text-gray-700">
                    ...
                    <input
                      ...
                      name="targetArea"
                      id="targetArea"
                      placeholder="e.g., I want to work on my upper body, focus on core strength"
                      className="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 bg-gray-50 text-gray-900"
                      required
                    />
                  </div>
                  ...
                  <div>
                    ...
                    <input
                      ...
                      name="equipment"
                      id="equipment"
                      placeholder="e.g., I have some light dumbbells and a yoga mat"
                      className="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 bg-gray-50 text-gray-900"
                      required
                    />
                  </div>
                ...
                {workoutPlan && (
                  <div className="mt-8 p-4 bg-gray-50 rounded-lg">
                    ...
                    <div className="whitespace-pre-wrap">{workoutPlan}</div>
                  </div>
                )}
              </div>
            </div>
